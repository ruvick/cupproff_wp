...
Container::make( 'theme_options', __( 'Настройки темы', 'crb' ) )
    ...
    ->show_on_post_type(array( 'ultra'))
      ...
      Field::make('text', 'offer_value', 'Обьем')->set_width(50),
      Field::make('text', 'offer_num_layers', 'Колличество слоев')->set_width(50),
      Field::make('text', 'offer_quantity', 'Колличество на складе')->set_width(50),
