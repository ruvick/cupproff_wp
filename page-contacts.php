...
<main class="page page-recurring">
  ...
  <ul> 
	  <? $org = carbon_get_theme_option("as_company"); if (!empty($org)){?><li>Организация: <strong><? echo $org; ?></strong></li><?}?> 
		...
		<? $tel = carbon_get_theme_option("as_phones_1"); $tel2 = carbon_get_theme_option("as_phone_2"); if (!empty($tel)){?><li>Тел: <strong><a href="tel:<? echo preg_replace('/[^0-9]/', '', $tel); ?>"><? echo $tel; ?></strong> (офис)</a> <a href="tel:<? echo preg_replace('/[^0-9]/', '', $tel2); ?>"><strong><? echo $tel2; ?></strong> (менеджер по продажам)</a></li><?}?> 
	</ul>
